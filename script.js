    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Shay AIZENBERG משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '1828ced3-a264-4c1c-8924-1ef64cad1e70',
                    name: data.name || '',
                    email: data.email || '',
